...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#ID3_Publish__By_pressing_the_b {
		left: 0px;
		top: 0px;
		position: absolute;
		overflow: hidden;
	...
	#You_can_upload_the_CSV_file_co_be {
		left: 28px;
		top: 83px;
		position: absolute;
		overflow: visible;
	...
	#ID1_Download_the_current_CSV_f_bg {
		left: 0px;
		top: 0px;
		position: absolute;
		overflow: hidden;
	...
	#Note_If_you_are_uploading_cont_bh {
		left: 0px;
		top: 215px;
		position: absolute;
		overflow: visible;
	...
	#ID2_Upload_your_CSV_File__You__bm {
		left: 0px;
		top: 0px;
		position: absolute;
		overflow: hidden;
	...
	#Note_for_developers_A_successf_bn {
		left: 0px;
		top: 217px;
		position: absolute;
		overflow: visible;
	...
	#Note_Once_you_publish_you_will_bw {
		left: 0px;
		top: 217px;
		position: absolute;
		overflow: visible;
	...
	#ID1_Download_the_current_CSV_f_b {
		left: 28px;
		top: 237px;
		position: absolute;
		overflow: hidden;
	...
	#Note_If_you_are_uploading_cont_b {
		left: 28px;
		top: 452px;
		position: absolute;
		overflow: visible;
	...
	#ID2_Upload_your_CSV_File__You__b {
		left: 0px;
		top: 0px;
		position: absolute;
		overflow: hidden;
	...
	#Note_for_developers_A_successf_ca {
		left: 0px;
		top: 217px;
		position: absolute;
		overflow: visible;
	...
	#Note_Once_you_publish_you_will_ch {
		left: 1167px;
		top: 454px;
		position: absolute;
		overflow: visible;
	...
	#Regional_IXN_Administrators_co {
		left: 21px;
		top: 16px;
		position: absolute;
		overflow: visible;
...
<div id="Admin_Home">
	<div id="This_is_the_contents_managemen">
		<span>This is the contents management system for the IBM IXN page. You can manage the contents relating to Projects using the appropriate CSV file format provided by the IXN. </span>
	</div>
	<div id="Block_Projects">
		...
		<div id="You_can_upload_the_CSV_file_co">
			<span>You can upload the CSV file containing the information about Projects. Please note that this will affect all of the project videos and information that can be found in the IBM IXN website: Upcoming Projects and Project Archives. </span>
		</div>

			<div id="Component_11__1" class="Component_11___1">

				<!-- download latest CSV button -->
				<form action="export_projects.php" method = "get">
		...
		<div id="Group_10796">
			<div id="ID3_Publish__By_pressing_the_b">
			...
			<div id="Component_11__3" class="Component_11___3">
				<svg class="Rectangle_334_" onclick="window.location='./generate.php';">
					<rect id="Rectangle_334_" rx="0" ry="0" x="0" y="0" width="233" height="59">
					</rect>
				</svg>
				<div id="Publish" onclick="window.location='./generate.php';">
					<span>Publish</span>
				</div>
			</div>
